...
skynet.start(function()
	skynet.error("cy===============================================dbtimea=", skynet.now(), skynet.starttime(), skynet.time())
	--nodemonitor
	...
	skynet.error("cy===============================================dbtimeb=", skynet.now(), skynet.starttime(), skynet.time())
 	skynet.error("******************** dbserver is start ********************")
end)