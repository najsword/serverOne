...
M_Gate = {
	module = MODULE.GATE,
	ping             = {id = 0x0001, type = PROTO_TYPE.S2C,  request = "gate.Ping", response = nil, desc = "ping"},
	heart_beat = {id = 0x0002, type = PROTO_TYPE.C2S, request = "gate.HeartbeatReq", response = "gate.HeartbeatReply", desc = "heartbeat"},
...
M_AUTH = {
	...
	auth_secret = {id = 0x0105, type = PROTO_TYPE.C2S, request = "auth.AuthSecretReq", response = "auth.AuthSecretReply", desc = "认证secret"},
}
...
M_AREA = {
	module = MODULE.AREA,
	enter_area = {id = 0x0701, type = PROTO_TYPE.C2S, request = "area.EnterAreaReq", response = nil, desc = "进入area"},
	exit_area = {id = 0x0702, type = PROTO_TYPE.C2S, request = "area.ExitAreaReq", response = nil, desc = "退出area"},
	get_role = {id = 0x0703, type = PROTO_TYPE.C2S, request = "area.GetRoleReq", response = nil, desc = "获取role_id"},
	create_role = {id = 0x0704, type = PROTO_TYPE.C2S, request = "area.CreateRoleReq", response = nil, desc = "创建role"},
	enter_room = {id = 0x0705, type = PROTO_TYPE.C2S, request = "area.EnterRoomReq", response = "area.EnterRoomReply", desc = "进入游戏房间"},
}
proto_map.area = M_AREA

--chat
M_CHAT = {
	module = MODULE.CHAT,
	chat_req = {id = 0x0801, type = PROTO_TYPE.C2S, request = "chat.ChatReq", response = nil, desc = "发送聊天信息"},
	chat_event = {id = 0x0802, type = PROTO_TYPE.S2C, request = "chat.ChatEvent", response = nil, desc = "接收聊天信息"},
}
proto_map.chat = M_CHAT

--登录
M_LOGIN = {
	module = MODULE.LOGIN,
	signin_account  = {id = 0x0901, type = PROTO_TYPE.C2S, request = "login.LoginReq", response = "login.LoginReply", desc = "登陆帐号"},
	logout_account  = {id = 0x0902, type = PROTO_TYPE.C2S, request = "login.LogoutReq", response = "login.LogoutReply", desc = "退出账号"},
	weixin_account = {id = 0x0903, type = PROTO_TYPE.C2S, request = "login.WeixinLoginReq", response = "login.WeixinLoginReply", desc = "微信登陆帐号"},
	vistor_account  = {id = 0x0904, type = PROTO_TYPE.C2S, request = "login.VistorLoginReq", response = "login.VistorLoginReply", desc = "游客登陆帐号"},
}
proto_map.login = M_LOGIN
...
M_ROOM = {
	...
	logout_desk = {id = 0x0d04, type = PROTO_TYPE.C2S, request = nil, response = nil, desc = "离开队伍"},
}
...
M_XPNN = {
	...
	game_start_event = {id = 0x10a2, type = PROTO_TYPE.S2C, request = "xpnn.GameStartEvent", response = nil, desc = "开始游戏事件"},
	...
	game_end_event = {id = 0x10a7, type = PROTO_TYPE.S2C, request = "xpnn.GameEndEvent", response = nil, desc = "游戏结束事件"},
	seat_state_event = {id = 0x10a8, type = PROTO_TYPE.S2C, request = "xpnn.SeatStateEvent", response = nil, desc = "坐位事件"},
	exit_desk_event = {id = 0x10a9, type = PROTO_TYPE.S2C, request = "xpnn.ExitDeskEvent", response = nil, desc = "解散玩家事件"},
}
